...
let package = Package(
    ...
    dependencies: [
        ...
        // Built from 1e4f48c4c2bb3ecb57355dd4cc747da73bef024b
        .package(url: "https://github.com/Electric-Coin-Company/zcash-light-client-ffi", revision: "bd9874be60a0b90b90e01e02628494de6273236e")
    ],
    targets: [
        .target(
            name: "ZcashLightClientKit",
