...
//        .package(url: "https://github.com/Electric-Coin-Company/zcash-light-client-ffi", exact: "0.14.1")
        .package(url: "https://github.com/Electric-Coin-Company/zcash-light-client-ffi", branch: "preview/hotfix/0.14.2")
    ],
    targets: [
        .target(
            name: "ZcashLightClientKit",
