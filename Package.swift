...
let package = Package(
    ...
    dependencies: [
        ...
        // Built from f090ad6a6fca9785dbb930ed4d804f37d6b77c0c
        .package(url: "https://github.com/Electric-Coin-Company/zcash-light-client-ffi", revision: "668571f280e0a9c8a664ca2d948b23d71c8de896")
    ],
    targets: [
        .target(
            name: "ZcashLightClientKit",
