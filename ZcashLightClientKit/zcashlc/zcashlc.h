...
char *zcashlc_deriveExtendedFullViewingKey(const char *extsk);

char **zcashlc_deriveExtendedFullViewingKeys(const uint8_t *seed,
                                             uintptr_t seed_len,
                                             int32_t accounts);

char **zcashlc_deriveExtendedSpendingKeys(const uint8_t *seed,
                                          uintptr_t seed_len,
                                          int32_t accounts);
