...
extension CallOptions {
    static var lwdSingleCall: CallOptions {
    ...
    static var lwdStreamingCall: CallOptions {
        CallOptions(customMetadata: HPACKHeaders(),
                    timeLimit: .timeout(.streamingCallTimeout),
                    messageEncoding: .disabled,
                    requestIDProvider: .autogenerated,
                    requestIDHeader: nil,
                    cacheable: false)
...
public class LightWalletGRPCService {
    ...
    public init(channel: Channel) {
        ...
        compactTxStreamer = CompactTxStreamerClient(channel: self.channel, defaultCallOptions: CallOptions.lwdSingleCall)
    }
...
extension LightWalletGRPCService: LightWalletService {
    ...
    public func submit(spendTransaction: Data, result: @escaping (Result<LightWalletServiceResponse, LightWalletServiceError>) -> Void) {
        do {
            ...
            result(.failure(.sentFailed(error: error)))
        }
    }
